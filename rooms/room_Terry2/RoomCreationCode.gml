...
obj_parent_textbox.text[2] = "That normally would never work if anyone else used that line, but with Terry, you have a feeling they'll come around to the idea."
